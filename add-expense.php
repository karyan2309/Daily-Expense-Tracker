...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into expenses(UserId,ExpenseDate,ExpenseCategory,ExpenseItem,ExpenseCost) value('$userid','$dateexpense','$category','$item','$costitem')");
if($query){
